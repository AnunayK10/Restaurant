...
export default function OAuth() {
  ...
  return (
    ...
    <button type='button' className='px-4 py-1 mb-2 font-medium text-white bg-red-600 border border-red-800  rounded-lg bottom-2 hover:bg-red-800' onClick={handleGoogleClick}>
