    ...
    <div className="flex items-center justify-center min-h-screen px-4 py-12 bg-gray-100 sm:px-6 lg:px-8">
      <div className="w-full max-w-4xl p-10 space-y-8 bg-white rounded-lg shadow-lg">
        ...
        <p className="text-lg text-center text-gray-700">
          Welcome to <span className="font-bold text-blue-500">Seoul Bowl </span>, where passion for flavor meets a love for the finest ingredients. Established with the goal of offering a memorable dining experience, our restaurant combines exquisite cuisine, a warm ambiance, and excellent service.
        </p>
        ...
        <div className="space-y-6">
          ...
          <p className="text-gray-600">
            From humble beginnings, <span className="font-bold text-blue-500">Seoul Bowl </span> was born out of a deep love for food and a desire to create a space where people could come together to enjoy mouth-watering dishes. Our chefs, with their innovative approach to traditional recipes, have crafted a menu that tantalizes the taste buds and warms the soul.
          </p>
          ...
          <p className="text-gray-600">
            At <span className="font-bold text-blue-500">Seoul Bowl</span>, we don’t just serve food – we create experiences. Join us for a delightful meal and allow us to treat you to our signature hospitality and flavorful dishes that will keep you coming back for more.
          </p>
        </div>
      </div>
    </div>
